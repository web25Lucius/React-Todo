  ...
  constructor() {
    ...
    this.state = {
      ...
      todo : [
        ...
        {
          task: 'Black Friday promotions',
          id: 124,
          complete: false
        },
        {
          task: 'cyber monday promotions',
          id: 1235,
          complete: false
        },
        {
          task: 'Holiday promotions',
          id: 1246,
          complete: false
        },
        {
          task: 'Negotiate raise',
          id: 1237,
          complete: false
        },
        {
          task: 'Interview with Jason Rodriguez?! Whaaaaaaaaaat?? 12/31 countdown',
          id: 1248,
          complete: false
        }
 ...
 //end of input onChange handler on TodoForm
  ...
  render() {
    return (
      ...
      <div className="App">
        <h1>How to get ahead in life.  A field guide to #Winning!</h1>
        <h3>First step: Comply with winning instructions.  Choosing losing instructions may compromise quality.</h3>
        <p className="header">
